...
//        }
        ...
        if (setterNameSet.contains("ctime")) {
            setFieldValByName("ctime", ToolUtils.timestamp2(), metaObject);
        }

        if (setterNameSet.contains("utime")) {
            setFieldValByName("utime", ToolUtils.timestamp2(), metaObject);
        }
    }
