...
CREATE TABLE sys_permission  (
                                 ...
                                 name varchar(300) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '菜单权限名称',
                                 ...
                                 url varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '访问地址URL',
                                 target varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'a target属性:_self _blank',
                                 pid varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '父级菜单权限名称',
...
CREATE TABLE sys_role_dept  (
                                ...
                                create_time datetime NULL DEFAULT NULL COMMENT '创建时间',
                                PRIMARY KEY (id) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色部门' ROW_FORMAT = Compact;
...
CREATE TABLE sys_content  (
                              id varchar(50) CHARACTER SET utf8mb4 NOT NULL COMMENT '主键',
                              ...
                              PRIMARY KEY (id) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COMMENT = '文章管理' ROW_FORMAT = Compact;
...
CREATE TABLE sys_files  (
                            ...
                            PRIMARY KEY (id) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文件上传';
...
CREATE TABLE `c_user` (
                          ...
                          PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='c端用户';


DROP TABLE IF EXISTS dishes;
CREATE TABLE `dishes` (
                          `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
                          `code` varchar(32) NOT NULL COMMENT '菜品的code',
                          `name` varchar(255) NOT NULL COMMENT '菜品的名称',
                          `url` varchar(255) NOT NULL DEFAULT '菜品图片地址在',
                          `description` varchar(1024) NOT NULL DEFAULT '' COMMENT '对菜品的详细描述，包括主要食材和口味特点',
                          `price` int(11) NOT NULL COMMENT '菜品的单价（单位：分）',
                          `rating` int(11) NOT NULL DEFAULT '0' COMMENT '推荐指数，五星级为最高推荐',
...
CREATE TABLE IF NOT EXISTS orders (
    `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
    `code` varchar(32) NOT NULL COMMENT '订单code',
    ...
    `payment_amount` int(11) NOT NULL DEFAULT '0' COMMENT '实际支付金额(分)',
...
CREATE TABLE IF NOT EXISTS order_details (
    ...
    `product_code` varchar(40) NOT NULL DEFAULT '' COMMENT '产品code',
...
CREATE TABLE `cart` (
                        ...
                        `product_code` varchar(40) NOT NULL COMMENT '产品code',
                        `quantity` int(11) NOT NULL COMMENT '数量',
                        `unit_price` int(11) NOT NULL COMMENT '商品单价',
                         `ctime` bigint(20) NOT NULL DEFAULT '0',
                        `utime` bigint(20) NOT NULL DEFAULT '0',
                        PRIMARY KEY (`id`) USING BTREE,
                        UNIQUE KEY `idx_uid_code` (`user_id`,`product_code`) COMMENT '确保唯一'
...
INSERT INTO `cooke`.`dishes` (`id`, `code`, `name`, `url`, `description`, `price`, `rating`, `ctime`, `utime`) VALUES (1778996352919842818, 'fkqrBbAw1712980722586Jl2cCNoD', 'The Hilton Hotel', '2024/0413/128779241994708-vr4RiSZ6.jpeg', 'test22222', 101, 0, 1712980757348, 1712983827804);
INSERT INTO `cooke`.`dishes` (`id`, `code`, `name`, `url`, `description`, `price`, `rating`, `ctime`, `utime`) VALUES (1779012035316875266, 'lJupBQlr1712984496315cBLmmbTB', 'Adobe Photoshop CC 2022', '2024/0413/131842555066666-zQmeIPFS.jpeg', 'fsdf', 11, 0, 1712984496321, 1712984670171);
INSERT INTO `cooke`.`dishes` (`id`, `code`, `name`, `url`, `description`, `price`, `rating`, `ctime`, `utime`) VALUES (1779842094332178433, 'jsMH3j9V1713182397805MH0MLELd', '蒜苗腊肉', '2024/0415/171367166239708-QZz6G1I7.jpeg', '', 120, 0, 1713182397812, 1713182397812);
INSERT INTO `cooke`.`dishes` (`id`, `code`, `name`, `url`, `description`, `price`, `rating`, `ctime`, `utime`) VALUES (1779844464353071106, 'XELxTpLu1713182962861RsmdlpFg', '香辣鱿鱼', '2024/0415/171949076478791-Xz4JgOkl.jpeg', '', 1200, 0, 1713182962869, 1713182977105);


INSERT INTO `cooke`.`cart` (`id`, `user_id`, `product_code`, `quantity`, `unit_price`, `ctime`, `utime`) VALUES (4, 1779119383055015937, 'lJupBQlr1712984496315cBLmmbTB', 2, 11, 1713077026336, 1713077091797);
INSERT INTO `cooke`.`cart` (`id`, `user_id`, `product_code`, `quantity`, `unit_price`, `ctime`, `utime`) VALUES (6, 1779119383055015937, 'fkqrBbAw1712980722586Jl2cCNoD', 1, 101, 1713077105160, 1713077105160);
INSERT INTO `cooke`.`cart` (`id`, `user_id`, `product_code`, `quantity`, `unit_price`, `ctime`, `utime`) VALUES (7, 1779119383055015937, 'jsMH3j9V1713182397805MH0MLELd', 1, 120, 1713182840066, 1713182840066);
INSERT INTO `cooke`.`cart` (`id`, `user_id`, `product_code`, `quantity`, `unit_price`, `ctime`, `utime`) VALUES (8, 1779119383055015937, 'XELxTpLu1713182962861RsmdlpFg', 1, 1200, 1713182990321, 1713182990321);
